...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/NiLphreakz/deku/main/acme.sh -o /root/.acme.sh/acme.sh
...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8447 -j ACCEPT
...
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 8447 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8443-j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8445 -j ACCEPT
...
# // ENABLE XRAY TCP XTLS 8447/8443/8445/443
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/deku/main/cert.sh"
